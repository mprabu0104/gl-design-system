...
export const FontFamiliesIrishGrover = "Irish Grover";
export const LineHeights0 = 24;
export const LineHeights1 = 32;
export const LineHeights2 = 26;
export const FontWeightsRoboto0 = "Regular";
export const FontWeightsRaleway1 = "Bold";
export const FontWeightsIrishGrover2 = "Regular";
export const FontSize0 = 14;
export const FontSize1 = 16;
...
export const FontComponentButtonLg = {"fontFamily":"Irish Grover","fontWeight":"Regular","lineHeight":26,"fontSize":14,"letterSpacing":"0%","paragraphSpacing":0,"textCase":"none","textDecoration":"none"};